...
public interface IHomeContract {
    ...
    interface View extends IBaseView<Presenter> {
        ...
        void updatePlayers(List<PlayerInfo> playerInfoList);

        /** 更新 GridView， 后续，刷新adapter notify */
        void updateAdapter(List<PlayerInfo> playerInfoList);

    }

    interface Presenter extends IBasePresenter {

        /** 获取选手列表，通过 updatePlayers(List<PlayerInfo> playerInfoList) 来更新 */
